...
public class Constants {
     ...
     */
    public static final String TEXTPASSISSUANC = "Для оформления пропуска необходимо:\n" +
     ...
     */
    private static final String TEXTSAFETYGUIDEFORDOGSSHELTER = "*Общие правила безопасности на территории приюта.\n" +
            " \n" +
     ...
     */
    private static final String DOCUMENTSFORADOPT = "Чтобы взять животное из приюта, вам необходимо подготовить " +
            "следующие документы:\n" +
